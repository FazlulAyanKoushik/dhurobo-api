...
exports.getAllFeaturedCategory = async (req, res, next) => {
    try {
        ...
        const data = await queryData.populate({path: 'products', select: '_id productName productSlug sku images price discountType discountAmount quantity'}).sort({priority: -1});
